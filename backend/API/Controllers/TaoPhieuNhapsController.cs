...
namespace API.Controllers
{
    ...
    public class TaoPhieuNhapsController : ControllerBase
    {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteTaoPhieuNhap(int id)
        {
            try
            {
                ...
                // Tìm các ChiTietPhieuNhapHang liên quan
                var chiTietList = _context.ChiTietPhieuNhapHangs
                    .Where(ct => ct.Id_PhieuNhapHang == id);
                ...
                {
                    TenSanPham = phieuNhapHang.SoChungTu,
                    TranType = "Delete"
                };
