...
export class ProductsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.service.dataSource.filterPredicate = (data: Product, filter: string): boolean => {
      return data.ten.toLowerCase().includes(filter);
    };
  }
  ...
  public doFilter = (value: string) => {
    this.service.dataSource.filter = value.trim().toLowerCase();
  }
  onSelectedAdd() {
